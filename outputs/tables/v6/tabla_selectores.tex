...
\centering
\small
\caption{Resumen por selector (n=10 semillas, media). Modelos A-D de campaign\_1\_v3; R y Q de las campañas de variante v6.}
\label{tab:tabla_selectores}
\begin{tabular}{lrrrrrr}
\toprule
Selector & Sharpe & cand\_hit & topm\_hit & coverage & converg. & lat.(ms) \\
\midrule
